...
START_RELOC_NUMBERS (elf_mips_reloc_type)
  ...
  RELOC_NUMBER (R_MIPS_SIGNED_8, 69)
  RELOC_NUMBER (R_MIPS_SIGNED_16, 70)
  FAKE_RELOC (R_MIPS_max, 71)
...
START_RELOC_NUMBERS (elf_mipsr7_reloc_type)
  ...
  R7_RELOC_OVERRIDE (HI32, 182)		/* R_MICROMIPS_max */
  FAKE_RELOC (R_MICROMIPSPP_max, 183)
...
START_RELOC_NUMBERS (elf_mipsr7_reloc_type)
  ...
  R7_RELOC_OVERRIDE (PC32, 229)
  R7_RELOC_OVERRIDE (GPREL32, 230)
  R7_RELOC_OVERRIDE (GPREL17_S1, 231)
  FAKE_RELOC (R_MICROMIPSPP_max, 232)
R7_END_RELOC_OVERRIDE (R_MIPSR7_maxext)
