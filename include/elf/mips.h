...
START_RELOC_NUMBERS (elf_mips_reloc_type)
  ...
  RELOC_NUMBER (R_MIPS_ASHIFTR_1, 66)
  RELOC_NUMBER (R_MIPS_UNSIGNED_8, 67)
  RELOC_NUMBER (R_MIPS_UNSIGNED_16, 68)
  FAKE_RELOC (R_MIPS_max, 69)
...
START_RELOC_NUMBERS (elf_mipsr7_reloc_type)
  ...
  R7_RELOC_OVERRIDE (LITERAL, 137)	/* R_MICROMIPS_LITERAL */
  R7_RELOC_OVERRIDE (32, 138)		/* R_MICROMIPS_GOT16 */
  ...
  R7_RELOC_OVERRIDE (CALL, 142)		/* R_MICROMIPS_CALL16 */
  R7_RELOC_OVERRIDE (GOT_DISP, 145)	/* R_MICROMIPS_GOT_DISP */
  R7_RELOC_OVERRIDE (GOT_PAGE, 146)	/* R_MICROMIPS_GOT_PAGE */
  R7_RELOC_OVERRIDE (GOT_OFST, 147)	/* R_MICROMIPS_GOT_OFST */
  R7_RELOC_OVERRIDE (GOT_HI20, 148)	/* R_MICROMIPS_GOT_HI16 */
  R7_RELOC_OVERRIDE (GOT_LO12, 149)	/* R_MICROMIPS_GOT_LO16 */
  R7_RELOC_OVERRIDE (GPREL_HI20, 151)	/* R_MICROMIPS_HIGHER */
  R7_RELOC_OVERRIDE (GPREL_LO12, 152)	/* R_MICROMIPS_HIGHEST */
  R7_RELOC_OVERRIDE (CALL_HI20, 153)	/* R_MICROMIPS_CALL_HI16 */
  R7_RELOC_OVERRIDE (CALL_LO12, 154)	/* R_MICROMIPS_CALL_LO16 */
  R7_RELOC_OVERRIDE (PCHI20, 158)	/* R_MICROMIPS_PCHI16	*/
  R7_RELOC_OVERRIDE (PCLO12, 159)	/* R_MICROMIPS_PCLO16	*/
  R7_RELOC_OVERRIDE (GPREL16_S2, 160)	/* UNUSED  */
  R7_RELOC_OVERRIDE (GPREL18_S3, 161)	/* UNUSED  */
  /* TLS relocations.  */
  R7_RELOC_OVERRIDE (TLS_GD, 162)	/* R_MICROMIPS_TLS_GD  */
  R7_RELOC_OVERRIDE (TLS_LDM, 163)	/* R_MICROMIPS_TLS_LDM  */
  R7_RELOC_OVERRIDE (TLS_DTPREL_HI20, 164) /* R_MICROMIPS_TLS_DTPREL_HI16  */
  R7_RELOC_OVERRIDE (TLS_DTPREL_LO12, 165) /* R_MICROMIPS__TLS_DTPREL_LO16  */
  R7_RELOC_OVERRIDE (TLS_GOTTPREL, 166)	/* R_MICROMIPS_TLS_GOTTPREL  */
  R7_RELOC_OVERRIDE (TLS_TPREL_HI20, 169) /* R_MICROMIPS_TLS_TPREL_HI16  */
  R7_RELOC_OVERRIDE (TLS_TPREL_LO12, 170) /* R_MICROMIPS_TLS_TPREL_LO16  */
  ...
  R7_RELOC_OVERRIDE (ALIGN, 178)
  R7_RELOC_OVERRIDE (FILL, 179)
  R7_RELOC_OVERRIDE (MAX, 180)
  R7_RELOC_OVERRIDE (INSN32, 181)
  R7_RELOC_OVERRIDE (INSN16, 182)
  R7_RELOC_OVERRIDE (FIXED, 183)
  R7_RELOC_OVERRIDE (RELAX, 184)
  R7_RELOC_OVERRIDE (NORELAX, 185)
  R7_RELOC_OVERRIDE (GPREL18, 186)
  R7_RELOC_OVERRIDE (GPREL19_S2, 187)
  R7_RELOC_OVERRIDE (PC4_S1, 188)
  R7_RELOC_OVERRIDE (HI32, 189)
  FAKE_RELOC (R_MICROMIPSPP_max, 190)
R7_END_RELOC_OVERRIDE (R_MIPSR7_maxext)

#else /* !RELOC_REUSE_MICROMIPSPP */

/* Use unique reloc numbers for intitial linker prototyping.  */

START_RELOC_NUMBERS (elf_mipsr7_reloc_type)
  FAKE_RELOC (R_MICROMIPSPP_min, 182)
  R7_RELOC_OVERRIDE (HI20, 182)
  R7_RELOC_OVERRIDE (LO12, 183)
  R7_RELOC_OVERRIDE (GPREL14, 184)
  R7_RELOC_OVERRIDE (PC7_S1, 185)	/* R_MICROMIPS_PC7_S1	*/
  R7_RELOC_OVERRIDE (PC10_S1, 186)	/* R_MICROMIPS_PC10_S1	*/
  R7_RELOC_OVERRIDE (PCHI20_M12, 187)
  R7_RELOC_OVERRIDE (PCHI20, 188)
  R7_RELOC_OVERRIDE (PCLO12, 189)
  R7_RELOC_OVERRIDE (GPREL7_S2, 190)	/* R_MICROMIPS_GPREL7_S2  */
  R7_RELOC_OVERRIDE (PC11_S1, 191)
  R7_RELOC_OVERRIDE (PC21_S1, 192)
  R7_RELOC_OVERRIDE (PC25_S1, 193)
  R7_RELOC_OVERRIDE (PC14_S1, 194)
  R7_RELOC_OVERRIDE (PC20_S1, 195)
  R7_RELOC_OVERRIDE (GPREL18, 196)
  R7_RELOC_OVERRIDE (GPREL19_S2, 197)
  R7_RELOC_OVERRIDE (PC4_S1, 198)
  R7_RELOC_OVERRIDE (GPREL16_S2, 199)
  R7_RELOC_OVERRIDE (GPREL18_S3, 200)
  R7_RELOC_OVERRIDE (LITERAL, 201)
  R7_RELOC_OVERRIDE (CALL, 202)
  R7_RELOC_OVERRIDE (GOT_DISP, 203)
  R7_RELOC_OVERRIDE (GOT_PAGE, 204)
  R7_RELOC_OVERRIDE (GOT_OFST, 205)
  R7_RELOC_OVERRIDE (GOT_HI20, 206)
  R7_RELOC_OVERRIDE (GOT_LO12, 207)
  R7_RELOC_OVERRIDE (CALL_HI20, 208)
  R7_RELOC_OVERRIDE (CALL_LO12, 209)
  R7_RELOC_OVERRIDE (32, 210)
  R7_RELOC_OVERRIDE (HI32, 211)
  R7_RELOC_OVERRIDE (GPREL_HI20, 212)
  R7_RELOC_OVERRIDE (GPREL_LO12, 213)
  /* TLS relocations.  */
  R7_RELOC_OVERRIDE (TLS_GD, 214)
  R7_RELOC_OVERRIDE (TLS_LDM, 215)
  R7_RELOC_OVERRIDE (TLS_DTPREL_HI20, 216)
  R7_RELOC_OVERRIDE (TLS_DTPREL_LO12, 217)
  R7_RELOC_OVERRIDE (TLS_GOTTPREL, 218)
  R7_RELOC_OVERRIDE (TLS_TPREL_HI20, 219)
  R7_RELOC_OVERRIDE (TLS_TPREL_LO12, 220)
  R7_RELOC_OVERRIDE (ALIGN, 221)
  R7_RELOC_OVERRIDE (FILL, 222)
  R7_RELOC_OVERRIDE (MAX, 223)
  R7_RELOC_OVERRIDE (INSN32, 224)
  R7_RELOC_OVERRIDE (INSN16, 225)
  R7_RELOC_OVERRIDE (FIXED, 226)
  R7_RELOC_OVERRIDE (RELAX, 227)
  R7_RELOC_OVERRIDE (NORELAX, 228)
  FAKE_RELOC (R_MICROMIPSPP_max, 229)
R7_END_RELOC_OVERRIDE (R_MIPSR7_maxext)
...
/* -mips32r7 code.  */
#define E_MIPS_ARCH_32R7        0xb0000000

/* -mips64r7 code.  */
#define E_MIPS_ARCH_64R7        0xc0000000
