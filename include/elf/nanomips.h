...
START_RELOC_NUMBERS (elf_nanomips_reloc_type)
  ...
  RELOC_NUMBER (R_NANOMIPS_16, 1)
  RELOC_NUMBER (R_NANOMIPS_32, 2)
  RELOC_NUMBER (R_NANOMIPS_64, 18)
  RELOC_NUMBER (R_NANOMIPS_SUB, 24)
  /* TLS relocations.  */
  RELOC_NUMBER (R_NANOMIPS_TLS_DTPMOD32, 38)
  RELOC_NUMBER (R_NANOMIPS_TLS_DTPREL32, 39)
  RELOC_NUMBER (R_NANOMIPS_TLS_DTPMOD64, 40)
  RELOC_NUMBER (R_NANOMIPS_TLS_DTPREL64, 41)
  RELOC_NUMBER (R_NANOMIPS_TLS_TPREL32, 47)
  RELOC_NUMBER (R_NANOMIPS_TLS_TPREL64, 48)
  RELOC_NUMBER (R_NANOMIPS_ASHIFTR_1, 66)
  RELOC_NUMBER (R_NANOMIPS_UNSIGNED_8, 67)
  RELOC_NUMBER (R_NANOMIPS_UNSIGNED_16, 68)
  RELOC_NUMBER (R_NANOMIPS_SIGNED_8, 69)
  RELOC_NUMBER (R_NANOMIPS_SIGNED_16, 70)
  RELOC_NUMBER (R_NANOMIPS_JUMP_SLOT, 127)
  FAKE_RELOC (R_NANOMIPS_min, 182)
  RELOC_NUMBER (R_NANOMIPS_HI20, 182)
  RELOC_NUMBER (R_NANOMIPS_LO12, 183)
  RELOC_NUMBER (R_NANOMIPS_PC7_S1, 185)	/* R_MICROMIPS_PC7_S1	*/
  RELOC_NUMBER (R_NANOMIPS_PC10_S1, 186)	/* R_MICROMIPS_PC10_S1	*/
  RELOC_NUMBER (R_NANOMIPS_PCHI20, 188)
  RELOC_NUMBER (R_NANOMIPS_PCLO12, 189)
  RELOC_NUMBER (R_NANOMIPS_GPREL7_S2, 190)	/* R_MICROMIPS_GPREL7_S2  */
  RELOC_NUMBER (R_NANOMIPS_PC11_S1, 191)
  RELOC_NUMBER (R_NANOMIPS_PC21_S1, 192)
  RELOC_NUMBER (R_NANOMIPS_PC25_S1, 193)
  RELOC_NUMBER (R_NANOMIPS_PC14_S1, 194)
  RELOC_NUMBER (R_NANOMIPS_PC20_S1, 195)
  RELOC_NUMBER (R_NANOMIPS_GPREL18, 196)
  RELOC_NUMBER (R_NANOMIPS_GPREL19_S2, 197)
  RELOC_NUMBER (R_NANOMIPS_PC4_S1, 198)
  RELOC_NUMBER (R_NANOMIPS_GPREL16_S2, 199)
  RELOC_NUMBER (R_NANOMIPS_GPREL18_S3, 200)
  RELOC_NUMBER (R_NANOMIPS_LITERAL, 201)
  RELOC_NUMBER (R_NANOMIPS_CALL, 202)
  RELOC_NUMBER (R_NANOMIPS_GOT_DISP, 203)
  RELOC_NUMBER (R_NANOMIPS_GOT_PAGE, 204)
  RELOC_NUMBER (R_NANOMIPS_GOT_OFST, 205)
  RELOC_NUMBER (R_NANOMIPS_GOT_HI20, 206)
  RELOC_NUMBER (R_NANOMIPS_GOT_LO12, 207)
  RELOC_NUMBER (R_NANOMIPS_CALL_HI20, 208)
  RELOC_NUMBER (R_NANOMIPS_CALL_LO12, 209)
  RELOC_NUMBER (R_NANOMIPS_I32, 210)
  RELOC_NUMBER (R_NANOMIPS_HI32, 211)
  RELOC_NUMBER (R_NANOMIPS_GPREL_HI20, 212)
  RELOC_NUMBER (R_NANOMIPS_GPREL_LO12, 213)
  /* TLS relocations.  */
  RELOC_NUMBER (R_NANOMIPS_TLS_GD, 214)
  RELOC_NUMBER (R_NANOMIPS_TLS_LDM, 215)
  RELOC_NUMBER (R_NANOMIPS_TLS_DTPREL_HI20, 216)
  RELOC_NUMBER (R_NANOMIPS_TLS_DTPREL_LO12, 217)
  RELOC_NUMBER (R_NANOMIPS_TLS_GOTTPREL, 218)
  RELOC_NUMBER (R_NANOMIPS_TLS_TPREL_HI20, 219)
  RELOC_NUMBER (R_NANOMIPS_TLS_TPREL_LO12, 220)
  RELOC_NUMBER (R_NANOMIPS_ALIGN, 221)
  RELOC_NUMBER (R_NANOMIPS_FILL, 222)
  RELOC_NUMBER (R_NANOMIPS_MAX, 223)
  RELOC_NUMBER (R_NANOMIPS_INSN32, 224)
  RELOC_NUMBER (R_NANOMIPS_INSN16, 225)
  RELOC_NUMBER (R_NANOMIPS_FIXED, 226)
  RELOC_NUMBER (R_NANOMIPS_RELAX, 227)
  RELOC_NUMBER (R_NANOMIPS_NORELAX, 228)
  RELOC_NUMBER (R_NANOMIPS_PC32, 229)
  RELOC_NUMBER (R_NANOMIPS_GPREL32, 230)
  RELOC_NUMBER (R_NANOMIPS_GPREL17_S1, 231)
  FAKE_RELOC (R_NANOMIPS_max, 232)
