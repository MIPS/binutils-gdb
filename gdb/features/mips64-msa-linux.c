...
initialize_tdesc_mips64_msa_linux (void)
{
  ...
  tdesc_create_reg (feature, "msacsr", 72, 1, "vector", 64, "int");
  tdesc_create_reg (feature, "msair", 73, 1, "vector", 64, "int");

  feature = tdesc_create_feature (result, "org.gnu.gdb.mips.linux");
  tdesc_create_reg (feature, "restart", 74, 1, "system", 64, "int");
