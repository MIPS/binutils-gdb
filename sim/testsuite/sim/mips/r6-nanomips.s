...
DIAG:
  ...
  writemsg "[9] Test MOVE"
  nanomips_ck_move 12345
  nanomips_ck_move 0xaabbccdd
  nanomips_ck_move -15316136
  nanomips_ck_move 0xffffcccc

  writemsg "[10] Test MOVEP"
  nanomips_ck_movep $a0, $a1, $s0, $s1, 0xaaaabbbb, 0xccccdddd
  nanomips_ck_movep $a1, $a2, $s1, $s2, 0xbbbbcccc, 0xddddeeee
  nanomips_ck_movep $a1, $a2, $s6, $s7, 0xbbbbcccc, 0xddddeeee
  nanomips_ck_movep $s0, $s1, $a0, $a1, 0xaabbccdd, 0xffffcccc
  nanomips_ck_movep $s2, $s3, $a2, $a3, 0xaabbccdd, 0xffffcccc
  nanomips_ck_movep $s6, $s7, $a2, $a3, 0xaabbccdd, 0xffffcccc

  writemsg "[11] Test MOVN"
