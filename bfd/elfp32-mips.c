...
static reloc_howto_type elf_nanomips_howto_table_rela[] =
{
  ...
  HOWTO (R_NANOMIPS_PCHI20_M12, /* type */
	 12,			/* rightshift */
	 2,			/* size (0 = byte, 1 = short, 2 = long) */
	 20,			/* bitsize */
	 TRUE,			/* pc_relative */
			       ...
			       char **error_message)
{
  ...
  /* R_MIPS_LITERAL/R_NANOMIPS_LITERAL relocations are defined for local
     symbols only.  */
...
static const struct elf_reloc_map nanomips_reloc_map[] =
{
  ...
  { BFD_RELOC_NANOMIPS_IMM14, R_NANOMIPS_LO12 - R_NANOMIPS_min },
  { BFD_RELOC_NANOMIPS_GPREL14, R_NANOMIPS_GPREL14 - R_NANOMIPS_min },
