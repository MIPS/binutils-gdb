...
#name: MIPSR7 %-operations in assembly
...
00000000 <test>:
   [0-9a-f]+:	4498 0000 	lwc1	\$f4,0\(gp\)
			[0-9a-f]+: R_MICROMIPS_GPREL16_S2	test
  ...
  [0-9a-f]+:	4480 0000 	lb	a0,0\(gp\)
			[0-9a-f]+: R_MICROMIPS_GPREL18	test
  [0-9a-f]+:	4490 0000 	lh	a0,0\(gp\)
			[0-9a-f]+: R_MICROMIPS_GPREL17_S1	test
  [0-9a-f]+:	4080 0002 	lw	a0,0\(gp\)
			[0-9a-f]+: R_MICROMIPS_GPREL19_S2	test
  ...
  [0-9a-f]+:	0000.
			[0-9a-f]+: R_MICROMIPS_GPREL32	test
  [0-9a-f]+:	9008      	nop
