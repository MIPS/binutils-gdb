...
[0-9a-f]+ <[^>]+> e05f 8ffd 	lui	v0,%hi\(0xffff8000\)
[0-9a-f]+ <[^>]+> 0040 ffff 	li	v0,65535
[0-9a-f]+ <[^>]+> e041 0000 	lui	v0,%hi\(0x10000\)
[0-9a-f]+ <[^>]+> e05f 8ffd 	lui	v0,%hi\(0xffff8000\)
...
[0-9a-f]+ <[^>]+> e07f 8ffd 	lui	v1,%hi\(0xffff8000\)
[0-9a-f]+ <[^>]+> 8463 0000 	lb	v1,0\(v1\)
...
[0-9a-f]+ <[^>]+> e07f 8ffd 	lui	v1,%hi\(0xffff8000\)
[0-9a-f]+ <[^>]+> 8463 0001 	lb	v1,1\(v1\)
[0-9a-f]+ <[^>]+> e060 0e01 	lui	v1,%hi\(0xf0000000\)
[0-9a-f]+ <[^>]+> 8463 0000 	lb	v1,0\(v1\)
[0-9a-f]+ <[^>]+> a460 80ff 	lb	v1,-1\(zero\)
[0-9a-f]+ <[^>]+> e074 5244 	lui	v1,%hi\(0x12345000\)
...
[0-9a-f]+ <[^>]+> e060 0e01 	lui	v1,%hi\(0xf0000000\)
[0-9a-f]+ <[^>]+> 8463 2000 	lbu	v1,0\(v1\)
[0-9a-f]+ <[^>]+> a460 90ff 	lbu	v1,-1\(zero\)
[0-9a-f]+ <[^>]+> e074 5244 	lui	v1,%hi\(0x12345000\)
...
[0-9a-f]+ <[^>]+> e060 0e01 	lui	v1,%hi\(0xf0000000\)
[0-9a-f]+ <[^>]+> 8463 6000 	lhu	v1,0\(v1\)
[0-9a-f]+ <[^>]+> a460 b0ff 	lhu	v1,-1\(zero\)
[0-9a-f]+ <[^>]+> e074 5244 	lui	v1,%hi\(0x12345000\)
...
[0-9a-f]+ <[^>]+> 345f      	lw	v0,124\(sp\)
[0-9a-f]+ <[^>]+> 345f      	lw	v0,124\(sp\)
[0-9a-f]+ <[^>]+> 347f      	lw	v1,124\(sp\)
[0-9a-f]+ <[^>]+> 349f      	lw	a0,124\(sp\)
[0-9a-f]+ <[^>]+> 34bf      	lw	a1,124\(sp\)
[0-9a-f]+ <[^>]+> 34df      	lw	a2,124\(sp\)
[0-9a-f]+ <[^>]+> 34ff      	lw	a3,124\(sp\)
[0-9a-f]+ <[^>]+> 351f      	lw	t0,124\(sp\)
[0-9a-f]+ <[^>]+> 353f      	lw	t1,124\(sp\)
[0-9a-f]+ <[^>]+> 355f      	lw	t2,124\(sp\)
[0-9a-f]+ <[^>]+> 37df      	lw	s8,124\(sp\)
...
[0-9a-f]+ <[^>]+> 8043 5001 	sltiu	v0,v1,1
[0-9a-f]+ <[^>]+> 8043 6001 	seqi	v0,v1,1
[0-9a-f]+ <[^>]+> 0043 0001 	addiu	v0,v1,1
[0-9a-f]+ <[^>]+> 8042 5001 	sltiu	v0,v0,1
[0-9a-f]+ <[^>]+> 0043 8001 	addiu	v0,v1,32769
[0-9a-f]+ <[^>]+> 8042 5001 	sltiu	v0,v0,1
...
[0-9a-f]+ <[^>]+> b45f      	sw	v0,124\(sp\)
[0-9a-f]+ <[^>]+> b63f      	sw	s1,124\(sp\)
[0-9a-f]+ <[^>]+> b47f      	sw	v1,124\(sp\)
...
[0-9a-f]+ <[^>]+> 8044 d608 	wsbh	v0,a0
[0-9a-f]+ <[^>]+> 8042 d608 	wsbh	v0,v0
[0-9a-f]+ <[^>]+> 8042 d608 	wsbh	v0,v0
