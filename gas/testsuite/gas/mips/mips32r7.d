...
[0-9a-f]+ <[^>]+> a461 1800 	pref	0x3,0\(at\)
[0-9a-f]+ <[^>]+> 87e2 37ff 	pref	0x1f,2047\(v0\)
[0-9a-f]+ <[^>]+> 8022 8800 	addiu	at,v0,-2048
[0-9a-f]+ <[^>]+> a7e1 1800 	synci	0\(at\)
[0-9a-f]+ <[^>]+> 87e2 3800 	pref	0x1f,2048\(v0\)
[0-9a-f]+ <[^>]+> 8022 8801 	addiu	at,v0,-2049
[0-9a-f]+ <[^>]+> a7e1 1800 	synci	0\(at\)
...
[0-9a-f]+ <[^>]+> 8043 8001 	addiu	v0,v1,-1
[0-9a-f]+ <[^>]+> 8044 8001 	addiu	v0,a0,-1
[0-9a-f]+ <[^>]+> 8045 8001 	addiu	v0,a1,-1
[0-9a-f]+ <[^>]+> 8046 8001 	addiu	v0,a2,-1
[0-9a-f]+ <[^>]+> 8047 8001 	addiu	v0,a3,-1
[0-9a-f]+ <[^>]+> 8050 8001 	addiu	v0,s0,-1
[0-9a-f]+ <[^>]+> 8051 8001 	addiu	v0,s1,-1
...
[0-9a-f]+ <[^>]+> 8064 8fff 	addiu	v1,a0,-4095
[0-9a-f]+ <[^>]+> 91c0      	addiu	s3,a0,0
[0-9a-f]+ <[^>]+> 0064 1fff 	addiu	v1,a0,8191
[0-9a-f]+ <[^>]+> 0064 3fff 	addiu	v1,a0,16383
[0-9a-f]+ <[^>]+> 0063 3fff 	addiu	v1,v1,16383
[0-9a-f]+ <[^>]+> 0063 3fff 	addiu	v1,v1,16383
...
[0-9a-f]+ <[^>]+> 0042 7fff 	addiu	v0,v0,32767
[0-9a-f]+ <[^>]+> 6041 8000 ffff 	addiu	v0,v0,-32768
[0-9a-f]+ <[^>]+> 0042 ffff 	addiu	v0,v0,65535
...
[0-9a-f]+ <[^>]+> a401 3900 	cache	0x0,0\(at\)
[0-9a-f]+ <[^>]+> a402 3900 	cache	0x0,0\(v0\)
[0-9a-f]+ <[^>]+> 8022 8800 	addiu	at,v0,-2048
[0-9a-f]+ <[^>]+> a401 3900 	cache	0x0,0\(at\)
...
[0-9a-f]+ <[^>]+> a7e1 3900 	cache	0x1f,0\(at\)
[0-9a-f]+ <[^>]+> 8023 8801 	addiu	at,v1,-2049
[0-9a-f]+ <[^>]+> a7e1 3900 	cache	0x1f,0\(at\)
[0-9a-f]+ <[^>]+> e021 0000 	lui	at,0x10
[0-9a-f]+ <[^>]+> 2061 0950 	addu	at,at,v1
[0-9a-f]+ <[^>]+> a7e1 3901 	cache	0x1f,1\(at\)
[0-9a-f]+ <[^>]+> a7e3 b9ff 	cache	0x1f,-1\(v1\)
...
[0-9a-f]+ <[^>]+> 2061 0950 	addu	at,at,v1
[0-9a-f]+ <[^>]+> a7e1 3901 	cache	0x1f,1\(at\)
[0-9a-f]+ <[^>]+> 0023 ffff 	addiu	at,v1,65535
[0-9a-f]+ <[^>]+> a7e1 3900 	cache	0x1f,0\(at\)
[0-9a-f]+ <[^>]+> e021 0000 	lui	at,0x10
[0-9a-f]+ <[^>]+> a7e1 3900 	cache	0x1f,0\(at\)
[0-9a-f]+ <[^>]+> 0020 0800 	li	at,2048
...
[0-9a-f]+ <[^>]+> 1017      	break	0x7
[0-9a-f]+ <[^>]+> 1064      	move	v1,a0
[0-9a-f]+ <[^>]+> 2080 1990 	neg	v1,a0
...
[0-9a-f]+ <[^>]+> 0064 7fff 	addiu	v1,a0,32767
[0-9a-f]+ <[^>]+> 8463 0000 	lb	v1,0\(v1\)
[0-9a-f]+ <[^>]+> e07f 8ffd 	lui	v1,0xffff8
[0-9a-f]+ <[^>]+> 2083 1950 	addu	v1,v1,a0
[0-9a-f]+ <[^>]+> 8463 0000 	lb	v1,0\(v1\)
[0-9a-f]+ <[^>]+> 0064 ffff 	addiu	v1,a0,65535
[0-9a-f]+ <[^>]+> 8463 0000 	lb	v1,0\(v1\)
[0-9a-f]+ <[^>]+> e07f 0ffd 	lui	v1,0xffff0
[0-9a-f]+ <[^>]+> 2083 1950 	addu	v1,v1,a0
[0-9a-f]+ <[^>]+> 8463 0000 	lb	v1,0\(v1\)
...
[0-9a-f]+ <[^>]+> 2083 1950 	addu	v1,v1,a0
[0-9a-f]+ <[^>]+> 8463 0000 	lb	v1,0\(v1\)
[0-9a-f]+ <[^>]+> 8064 8001 	addiu	v1,a0,-1
[0-9a-f]+ <[^>]+> 8463 0000 	lb	v1,0\(v1\)
[0-9a-f]+ <[^>]+> e074 5244 	lui	v1,0x12345
[0-9a-f]+ <[^>]+> 2083 1950 	addu	v1,v1,a0
[0-9a-f]+ <[^>]+> 8463 0678 	lb	v1,1656\(v1\)
...
[0-9a-f]+ <[^>]+> 2083 1950 	addu	v1,v1,a0
[0-9a-f]+ <[^>]+> 8463 6678 	lhu	v1,1656\(v1\)
[0-9a-f]+ <[^>]+> a460 5100 	ll	v1,0\(zero\)
[0-9a-f]+ <[^>]+> a460 5100 	ll	v1,0\(zero\)
[0-9a-f]+ <[^>]+> a460 5104 	ll	v1,4\(zero\)
[0-9a-f]+ <[^>]+> a460 5104 	ll	v1,4\(zero\)
[0-9a-f]+ <[^>]+> 0060 7fff 	li	v1,32767
...
[0-9a-f]+ <[^>]+> 2043 0008 	seb	v0,v1
[0-9a-f]+ <[^>]+> 2042 0008 	seb	v0,v0
[0-9a-f]+ <[^>]+> 2042 0008 	seb	v0,v0
[0-9a-f]+ <[^>]+> 2043 0048 	seh	v0,v1
[0-9a-f]+ <[^>]+> 2042 0048 	seh	v0,v0
[0-9a-f]+ <[^>]+> 2042 0048 	seh	v0,v0
...
[0-9a-f]+ <[^>]+> 2082 11d0 	subu	v0,v0,a0
[0-9a-f]+ <[^>]+> 0042 0000 	addiu	v0,v0,0
[0-9a-f]+ <[^>]+> 8042 8001 	addiu	v0,v0,-1
[0-9a-f]+ <[^>]+> 6041 8001 ffff 	addiu	v0,v0,-32767
[0-9a-f]+ <[^>]+> 0042 8000 	addiu	v0,v0,32768
[0-9a-f]+ <[^>]+> 6041 0001 ffff 	addiu	v0,v0,-65535
[0-9a-f]+ <[^>]+> 7d40      	sw	s2,0\(a0\)
[0-9a-f]+ <[^>]+> 7d40      	sw	s2,0\(a0\)
[0-9a-f]+ <[^>]+> 7d41      	sw	s2,4\(a0\)
[0-9a-f]+ <[^>]+> 7d42      	sw	s2,8\(a0\)
[0-9a-f]+ <[^>]+> 7d43      	sw	s2,12\(a0\)
[0-9a-f]+ <[^>]+> 7d44      	sw	s2,16\(a0\)
[0-9a-f]+ <[^>]+> 7d45      	sw	s2,20\(a0\)
[0-9a-f]+ <[^>]+> 7d46      	sw	s2,24\(a0\)
[0-9a-f]+ <[^>]+> 7d47      	sw	s2,28\(a0\)
[0-9a-f]+ <[^>]+> 7d48      	sw	s2,32\(a0\)
[0-9a-f]+ <[^>]+> 7d49      	sw	s2,36\(a0\)
[0-9a-f]+ <[^>]+> 7d4a      	sw	s2,40\(a0\)
[0-9a-f]+ <[^>]+> 7d4b      	sw	s2,44\(a0\)
[0-9a-f]+ <[^>]+> 7d4c      	sw	s2,48\(a0\)
[0-9a-f]+ <[^>]+> 7d4d      	sw	s2,52\(a0\)
[0-9a-f]+ <[^>]+> 7d4e      	sw	s2,56\(a0\)
[0-9a-f]+ <[^>]+> 7d4f      	sw	s2,60\(a0\)
[0-9a-f]+ <[^>]+> 7d5f      	sw	s2,60\(a1\)
[0-9a-f]+ <[^>]+> 7d6f      	sw	s2,60\(a2\)
[0-9a-f]+ <[^>]+> 7d7f      	sw	s2,60\(a3\)
[0-9a-f]+ <[^>]+> 7d0f      	sw	s2,60\(s0\)
[0-9a-f]+ <[^>]+> 7d1f      	sw	s2,60\(s1\)
[0-9a-f]+ <[^>]+> 7d2f      	sw	s2,60\(s2\)
[0-9a-f]+ <[^>]+> 7d3f      	sw	s2,60\(s3\)
[0-9a-f]+ <[^>]+> 7dbf      	sw	s3,60\(s3\)
[0-9a-f]+ <[^>]+> 7e3f      	sw	a0,60\(s3\)
[0-9a-f]+ <[^>]+> 7ebf      	sw	a1,60\(s3\)
[0-9a-f]+ <[^>]+> 7f3f      	sw	a2,60\(s3\)
[0-9a-f]+ <[^>]+> 7fbf      	sw	a3,60\(s3\)
[0-9a-f]+ <[^>]+> 7cbf      	sw	s1,60\(s3\)
[0-9a-f]+ <[^>]+> 7c3f      	sw	zero,60\(s3\)
[0-9a-f]+ <[^>]+> 5c00      	sw	zero,0\(sp\)
[0-9a-f]+ <[^>]+> 5c00      	sw	zero,0\(sp\)
[0-9a-f]+ <[^>]+> 5c01      	sw	zero,4\(sp\)
[0-9a-f]+ <[^>]+> 5c02      	sw	zero,8\(sp\)
[0-9a-f]+ <[^>]+> 5c03      	sw	zero,12\(sp\)
[0-9a-f]+ <[^>]+> 5c04      	sw	zero,16\(sp\)
[0-9a-f]+ <[^>]+> 5c05      	sw	zero,20\(sp\)
[0-9a-f]+ <[^>]+> 5c1e      	sw	zero,120\(sp\)
[0-9a-f]+ <[^>]+> 5c1f      	sw	zero,124\(sp\)
[0-9a-f]+ <[^>]+> 5c5f      	sw	v0,124\(sp\)
[0-9a-f]+ <[^>]+> 5e3f      	sw	s1,124\(sp\)
[0-9a-f]+ <[^>]+> 5c7f      	sw	v1,124\(sp\)
[0-9a-f]+ <[^>]+> 5c9f      	sw	a0,124\(sp\)
[0-9a-f]+ <[^>]+> 5cbf      	sw	a1,124\(sp\)
[0-9a-f]+ <[^>]+> 5cdf      	sw	a2,124\(sp\)
[0-9a-f]+ <[^>]+> 5cff      	sw	a3,124\(sp\)
[0-9a-f]+ <[^>]+> 5fff      	sw	ra,124\(sp\)
...
[0-9a-f]+ <[^>]+> 8460 6004 	lhu	v1,4\(zero\)
[0-9a-f]+ <[^>]+> 8460 6004 	lhu	v1,4\(zero\)
[0-9a-f]+ <[^>]+> 8464 6000 	lhu	v1,0\(a0\)
[0-9a-f]+ <[^>]+> 8464 6000 	lhu	v1,0\(a0\)
[0-9a-f]+ <[^>]+> 0024 7ffb 	addiu	at,a0,32763
[0-9a-f]+ <[^>]+> 8461 6000 	lhu	v1,0\(at\)
[0-9a-f]+ <[^>]+> e03f 8ffd 	lui	at,0xffff8
[0-9a-f]+ <[^>]+> 2081 0950 	addu	at,at,a0
[0-9a-f]+ <[^>]+> 8461 6000 	lhu	v1,0\(at\)
[0-9a-f]+ <[^>]+> 0024 ffff 	addiu	at,a0,65535
...
[0-9a-f]+ <[^>]+> 0043 0000 	addiu	v0,v1,0
			[0-9a-f]+: R_MICROMIPS_LO12	test
[0-9a-f]+ <[^>]+> a442 5100 	ll	v0,0\(v0\)
[0-9a-f]+ <[^>]+> 0023 0000 	addiu	at,v1,0
			[0-9a-f]+: R_MICROMIPS_LO12	test
[0-9a-f]+ <[^>]+> a441 5900 	sc	v0,0\(at\)
[0-9a-f]+ <[^>]+> 0023 0000 	addiu	at,v1,0
			[0-9a-f]+: R_MICROMIPS_LO12	test
...
[0-9a-f]+ <[^>]+> dd63      	movep	a1,a2,zero,zero
[0-9a-f]+ <[^>]+> dc6b      	movep	a2,a3,zero,zero
[0-9a-f]+ <[^>]+> dc63      	movep	a0,a1,zero,zero
[0-9a-f]+ <[^>]+> dd63      	movep	a1,a2,zero,zero
[0-9a-f]+ <[^>]+> dc6b      	movep	a2,a3,zero,zero
[0-9a-f]+ <[^>]+> dc79      	movep	a2,a3,s1,zero
[0-9a-f]+ <[^>]+> dc69      	movep	a2,a3,t1,zero
[0-9a-f]+ <[^>]+> dc6a      	movep	a2,a3,t2,zero
[0-9a-f]+ <[^>]+> dc78      	movep	a2,a3,s0,zero
[0-9a-f]+ <[^>]+> dc7a      	movep	a2,a3,s2,zero
[0-9a-f]+ <[^>]+> dc7b      	movep	a2,a3,s3,zero
[0-9a-f]+ <[^>]+> dc7c      	movep	a2,a3,s4,zero
[0-9a-f]+ <[^>]+> de3c      	movep	a2,a3,s4,s1
[0-9a-f]+ <[^>]+> dc3c      	movep	a2,a3,s4,t1
[0-9a-f]+ <[^>]+> dc5c      	movep	a2,a3,s4,t2
[0-9a-f]+ <[^>]+> de1c      	movep	a2,a3,s4,s0
[0-9a-f]+ <[^>]+> de5c      	movep	a2,a3,s4,s2
[0-9a-f]+ <[^>]+> de7c      	movep	a2,a3,s4,s3
[0-9a-f]+ <[^>]+> de9c      	movep	a2,a3,s4,s4
