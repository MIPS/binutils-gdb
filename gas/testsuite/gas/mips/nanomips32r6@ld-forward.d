...
#as: -m32 --defsym tld=1 --defsym forward=1
...
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_I32	small_external_data_label\+0xffc
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
...
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_I32	small_external_common\+0xffc
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
...
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_I32	.sbss\+0xffc
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> lui	at,0x0
