...
[0-9a-f]+ <[^>]+> 4be2 1000 	jalrc\.hb	v0
[0-9a-f]+ <[^>]+> 4802 1000 	jrc\.hb	v0
[0-9a-f]+ <[^>]+> 5540      	lw	s2,-256\(gp\)
[0-9a-f]+ <[^>]+> 55c0      	lw	s3,-256\(gp\)
[0-9a-f]+ <[^>]+> 5640      	lw	a0,-256\(gp\)
[0-9a-f]+ <[^>]+> 56c0      	lw	a1,-256\(gp\)
[0-9a-f]+ <[^>]+> 5740      	lw	a2,-256\(gp\)
[0-9a-f]+ <[^>]+> 57c0      	lw	a3,-256\(gp\)
[0-9a-f]+ <[^>]+> 5440      	lw	s0,-256\(gp\)
[0-9a-f]+ <[^>]+> 54c0      	lw	s1,-256\(gp\)
[0-9a-f]+ <[^>]+> 54c1      	lw	s1,-252\(gp\)
[0-9a-f]+ <[^>]+> 54ff      	lw	s1,-4\(gp\)
