...
#as: -p32 --defsym tld=1 --defsym forward=1
#name: nanoMIPS ld forward
#source: ld.s
...
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_32	.data\+0xffc
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_32	big_external_data_label\+0xffc
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> lw	a0,0\(gp\)
...
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_32	big_external_common\+0xffc
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> lw	a0,0\(gp\)
...
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_32	.bss\+0xffc
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> lw	a0,0\(gp\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	small_external_data_label\+0x4
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	big_external_common
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	small_external_common\+0x4
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	.bss
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	.sbss\+0x4
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	.data\+0x1
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	small_external_data_label\+0x5
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	big_external_common\+0x1
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	small_external_common\+0x5
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	.bss\+0x1
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	.sbss\+0x5
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_32	.data\+0xffc
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_32	small_external_data_label\+0xffc
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
...
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_32	small_external_common\+0xffc
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
...
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> li	at,0x0
			[0-9a-f]+: R_NANOMIPS_32	.sbss\+0xffc
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
[0-9a-f]+ <[^>]+> lw	a1,4\(at\)
[0-9a-f]+ <[^>]+> lui	at,0x0
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	big_external_data_label\+0x1004
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	small_external_data_label\+0x1000
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	small_external_data_label\+0x1000
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	small_external_data_label\+0x1004
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	big_external_common\+0x1000
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	big_external_common\+0x1004
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	small_external_common\+0x1000
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	small_external_common\+0x1000
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	small_external_common\+0x1004
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	.bss\+0x1000
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	.bss\+0x1004
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	.sbss\+0x1000
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	.sbss\+0x1000
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	.sbss\+0x1004
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	.data\+0x1a5a5
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	small_external_data_label\+0x1a5a9
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	big_external_common\+0x1a5a5
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	small_external_common\+0x1a5a9
[0-9a-f]+ <[^>]+> lui	at,0x0
			[0-9a-f]+: R_NANOMIPS_HI20	.bss\+0x1a5a5
[0-9a-f]+ <[^>]+> addu	at,a1,at
[0-9a-f]+ <[^>]+> lw	a0,0\(at\)
...
[0-9a-f]+ <[^>]+> lw	a1,0\(at\)
			[0-9a-f]+: R_NANOMIPS_LO12	.sbss\+0x1a5a9
[0-9a-f]+ <[^>]+> nop
	\.\.\.
#pass
