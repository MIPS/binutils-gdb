...
[0-9a-f]+ <[^>]*> 7c62 fffe 	bnec	v0,v1,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	.L11
[0-9a-f]+ <[^>]*> e440 fffe 	blezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	ext
[0-9a-f]+ <[^>]*> e440 8000 	blezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> e440 7fff 	blezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> e440 fffe 	blezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	.L11
[0-9a-f]+ <[^>]*> e442 fffe 	bgezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	ext
[0-9a-f]+ <[^>]*> e442 8000 	bgezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> e442 7fff 	bgezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> e442 fffe 	bgezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	f
[0-9a-f]+ <[^>]*> e462 fffe 	bgec	v0,v1,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	ext
[0-9a-f]+ <[^>]*> e462 8000 	bgec	v0,v1,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> e462 7fff 	bgec	v0,v1,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> e462 fffe 	bgec	v0,v1,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	.L11
[0-9a-f]+ <[^>]*> e443 fffe 	bgec	v1,v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	.L11
[0-9a-f]+ <[^>]*> c440 fffe 	bgtzc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	ext
[0-9a-f]+ <[^>]*> c440 8000 	bgtzc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> c440 7fff 	bgtzc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> c440 fffe 	bgtzc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	.L11
[0-9a-f]+ <[^>]*> c442 fffe 	bltzc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	ext
[0-9a-f]+ <[^>]*> c442 8000 	bltzc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> c442 7fff 	bltzc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> c442 fffe 	bltzc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	.L11
[0-9a-f]+ <[^>]*> c462 fffe 	bltc	v0,v1,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	ext
[0-9a-f]+ <[^>]*> c462 8000 	bltc	v0,v1,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> c462 7fff 	bltc	v0,v1,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	L0
[0-9a-f]+ <[^>]*> c462 fffe 	bltc	v0,v1,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	.L11
[0-9a-f]+ <[^>]*> c443 fffe 	bltc	v1,v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC16_S1	.L11
...
[0-9a-f]+ <[^>]*> a050 0000 	beqzc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC21_S1	L0
[0-9a-f]+ <[^>]*> a04f ffff 	beqzc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC21_S1	L0
[0-9a-f]+ <[^>]*> a05f fffe 	beqzc	v0,[0-9a-f]+ <[^>]*>
...
[	]*[0-9a-f]+: R_MICROMIPS_PC21_S1	ext
[0-9a-f]+ <[^>]*> a450 0000 	bnezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC21_S1	L0
[0-9a-f]+ <[^>]*> a44f ffff 	bnezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC21_S1	L0
[0-9a-f]+ <[^>]*> a45f fffe 	bnezc	v0,[0-9a-f]+ <[^>]*>
[	]*[0-9a-f]+: R_MICROMIPS_PC21_S1	.L11
[0-9a-f]+ <[^>]*> a403 8000 	jialc	v1,-[0-9]+
[0-9a-f]+ <[^>]*> a403 7fff 	jialc	v1,[0-9]+
