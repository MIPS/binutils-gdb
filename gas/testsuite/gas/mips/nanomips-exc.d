...
[0-9a-f]+ <[^>]+> 1083      	move	a0,v1
[0-9a-f]+ <[^>]+> 2003 2290 	move	a0,v1
[0-9a-f]+ <[^>]+> 2062 261f 	extw	a0,v0,v1,0x18
[0-9a-f]+ <[^>]+> 2062 241f 	extw	a0,v0,v1,0x10
[0-9a-f]+ <[^>]+> 2062 221f 	extw	a0,v0,v1,0x8
...
[0-9a-f]+ <[^>]+> 04a0 0000 	lapc	a1,00000114 <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC21_S1	test-0x4
[0-9a-f]+ <[^>]+> 04a0 0000 	lapc	a1,00000118 <[^>]+>
...
[0-9a-f]+ <[^>]+> 606b 2710 0000 	lwpc	v1,00002856 <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC32	\*ABS\*\+0x270c
[0-9a-f]+ <[^>]+> 606f 2710 0000 	swpc	v1,0000285c <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC32	\*ABS\*\+0x270c
[0-9a-f]+ <[^>]+> 60bb 2710 0000 	ldpc	a1,00002862 <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC32	\*ABS\*\+0x270c
[0-9a-f]+ <[^>]+> 611f 2710 0000 	sdpc	t0,00002868 <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC32	\*ABS\*\+0x270c
[0-9a-f]+ <[^>]+> 6063 0000 0000 	lapc	v1,0000015e <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC32	test-0x4
[0-9a-f]+ <[^>]+> 606b 0000 0000 	lwpc	v1,00000164 <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC32	test-0x4
[0-9a-f]+ <[^>]+> 606f 0000 0000 	swpc	v1,0000016a <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC32	test-0x4
[0-9a-f]+ <[^>]+> 60bb 0000 0000 	ldpc	a1,00000170 <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC32	test-0x4
[0-9a-f]+ <[^>]+> 611f 0000 0000 	sdpc	t0,00000176 <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC32	test-0x4
...
[0-9a-f]+ <[^>]+> 3ca3      	addu	a1,a1,t3
[0-9a-f]+ <[^>]+> 3c51      	addu	t2,t2,s1
[0-9a-f]+ <[^>]+> 3e76      	addu	s3,s3,s6
[0-9a-f]+ <[^>]+> 3ea1      	addu	s5,s5,t1
[0-9a-f]+ <[^>]+> 3ccf      	mul	a2,a2,a3
[0-9a-f]+ <[^>]+> 3c2b      	mul	t1,t1,t3
[0-9a-f]+ <[^>]+> 3e3b      	mul	s1,s1,s3
[0-9a-f]+ <[^>]+> 3edc      	mul	s6,s6,s4
[0-9a-f]+ <[^>]+> 3ce9      	mul	a3,a3,t1
[0-9a-f]+ <[^>]+> 3c78      	mul	t3,t3,s0
[0-9a-f]+ <[^>]+> 3e5d      	mul	s2,s2,s5
[0-9a-f]+ <[^>]+> 3ee8      	mul	s7,s7,t0
#pass
