...
#name: nanoMIPS ld PC-relative
#as: -mpcrel
#source: ld.s

# Test PC-relative expansion of the ld macro on nanoMIPS

.*: +file format .*nanomips.*

Disassembly of section \.text:
[0-9a-f]+ <text_label> lw	a0,0\(zero\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a1,4\(zero\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,1\(zero\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a1,5\(zero\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> li	at,4092
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(at\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a1,4\(at\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> li	at,-4092
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(at\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a1,4\(at\)
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(at\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a1,4\(at\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lwpc	a0,[0-9a-f]+ <\*ABS\*\+0x[0-9a-f]+>
			[0-9a-f]+: R_NANOMIPS_PC_I32	\*ABS\*\+0x1a5a5
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lwpc	a1,[0-9a-f]+ <\*ABS\*\+0x[0-9a-f]+>
			[0-9a-f]+: R_NANOMIPS_PC_I32	\*ABS\*\+0x1a5a9
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(a1\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a1,4\(a1\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,1\(a1\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a1,5\(a1\)
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lwpc	a1,[0-9a-f]+ <data_label\+0x[0-9a-f]+>
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lwpc	a1,[0-9a-f]+ <big_external_data_label\+0x[0-9a-f]+>
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a1,0\(gp\)
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lwpc	a1,[0-9a-f]+ <big_external_common\+0x[0-9a-f]+>
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lwpc	a1,[0-9a-f]+ <big_local_common\+0x[0-9a-f]+>
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lwpc	a1,[0-9a-f]+ <small_external_data_label\+0x[0-9a-f]+>
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lwpc	a1,[0-9a-f]+ <small_external_common\+0x[0-9a-f]+>
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lwpc	a1,[0-9a-f]+ <small_local_common\+0x[0-9a-f]+>
