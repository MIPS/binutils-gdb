...
[0-9a-f]+ <[^>]+> c884 c000 	bbeqzc	a0,0x18,[0-9a-f]+ <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC11_S1	test
[0-9a-f]+ <[^>]+> c884 0800 	bbeqzc	a0,0x1,[0-9a-f]+ <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC11_S1	test
[0-9a-f]+ <[^>]+> c884 f800 	bbeqzc	a0,0x1f,[0-9a-f]+ <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC11_S1	test
[0-9a-f]+ <[^>]+> c894 0000 	bbnezc	a0,0x0,[0-9a-f]+ <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC11_S1	test
[0-9a-f]+ <[^>]+> c894 8000 	bbnezc	a0,0x10,[0-9a-f]+ <[^>]+>
			[0-9a-f]+: R_NANOMIPS_PC11_S1	test
...
[0-9a-f]+ <[^>]+> 8043 d01f 	rotx	t4,t5,0x1f,0,0
[0-9a-f]+ <[^>]+> 8043 d01f 	rotx	t4,t5,0x1f,0,0
[0-9a-f]+ <[^>]+> 8043 d247 	rotx	t4,t5,0x7,8,1
[0-9a-f]+ <[^>]+> 8043 d247 	rotx	t4,t5,0x7,8,1
[0-9a-f]+ <[^>]+> 8043 d247 	rotx	t4,t5,0x7,8,1
[0-9a-f]+ <[^>]+> 8043 d40f 	rotx	t4,t5,0xf,16,0
[0-9a-f]+ <[^>]+> 8043 d40f 	rotx	t4,t5,0xf,16,0
[0-9a-f]+ <[^>]+> 8043 d218 	rotx	t4,t5,0x18,8,0
[0-9a-f]+ <[^>]+> 8043 d218 	rotx	t4,t5,0x18,8,0
[0-9a-f]+ <[^>]+> 8043 d608 	rotx	t4,t5,0x8,24,0
[0-9a-f]+ <[^>]+> 8043 d608 	rotx	t4,t5,0x8,24,0
[0-9a-f]+ <[^>]+> 8043 d608 	rotx	t4,t5,0x8,24,0
...
[0-9a-f]+ <[^>]+> e060 0002 	aluipc	t5,[0-9a-f]+ <[^>]+>
