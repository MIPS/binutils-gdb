...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,1445\(a0\)
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <data_label>\)
			[0-9a-f]+: R_NANOMIPS_PCHI20	data_label
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(a0\)
			[0-9a-f]+: R_NANOMIPS_LO12	\.data
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <big_external_data_label>\)
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <big_external_common>\)
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <big_local_common>\)
			[0-9a-f]+: R_NANOMIPS_PCHI20	big_local_common
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(a0\)
			[0-9a-f]+: R_NANOMIPS_LO12	\.bss
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(gp\)
			[0-9a-f]+: R_NANOMIPS_GPREL19_S2	\.sbss
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <data_label\+0x[0-9a-f]+>\)
			[0-9a-f]+: R_NANOMIPS_PCHI20	data_label\+0x1
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(a0\)
			[0-9a-f]+: R_NANOMIPS_LO12	\.data\+0x1
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <big_external_data_label\+0x[0-9a-f]+>\)
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <big_external_common\+0x[0-9a-f]+>\)
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <big_local_common\+0x[0-9a-f]+>\)
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(a0\)
			[0-9a-f]+: R_NANOMIPS_LO12	big_external_data_label-0xffc
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <small_external_data_label\+0x[0-9a-f]+>\)
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(a0\)
			[0-9a-f]+: R_NANOMIPS_LO12	big_external_common-0xffc
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <small_external_common\+0x[0-9a-f]+>\)
...
[0-9a-f]+ <text_label\+0x[0-9a-f]+> lw	a0,0\(a0\)
			[0-9a-f]+: R_NANOMIPS_LO12	\.bss-0xffc
[0-9a-f]+ <text_label\+0x[0-9a-f]+> aluipc	a0,%pcrel_hi\([0-9a-f]+ <small_local_common\+0x[0-9a-f]+>\)
