...
{"llwp",		"t,-p,A(s)",	0,    (int) M_LLWP_AB,	INSN_MACRO,		0,		I37,		0,	0 },
...
{"lldp",		"t,-p,A(s)",	0,    (int) M_LLDP_AB,	INSN_MACRO,		0,		I69,		0,	0 },
...
{"scwp",		"t,-p,A(s)",	0,    (int) M_SCWP_AB,	INSN_MACRO,		0,		I37,		0,	0 },
...
{"scdp",		"t,-p,A(s)",	0,    (int) M_SCDP_AB,	INSN_MACRO,		0,		I69,		0,	0 },
...
{"llwpe",		"t,-p,A(s)",	0,    (int) M_LLWPE_AB,	INSN_MACRO,		0,		0,		EVA_R6,	0 },
...
{"scwpe",		"t,-p,A(s)",	0,    (int) M_SCWPE_AB,	INSN_MACRO,		0,		0,		EVA_R6,	0 },
