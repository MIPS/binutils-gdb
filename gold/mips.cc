...
// Holds information needed for reporting overflow errors.
...
struct Overflow_info
{
  ...
  Overflow_info()
    : value(0), name(NULL), insn(0), bitsize(0)
  { }
 ...
 public:
                      ...
                      Overflow_info<big_endian>* overflow_info)
  {
        ...
        && (check_overflow<8>(x, CHECK_SIGNED) == This::STATUS_OVERFLOW))
    {
      ...
      overflow_info->name = "R_MICROMIPS_PC7_S1";
      overflow_info->bitsize = 8;
      return This::STATUS_OVERFLOW;
    }

    x = ((x & ~0x1) | ((x >> 7) & 0x1));
    val = Bits<7>::bit_select32(val, x, 0x7f);
    elfcpp::Swap<16, big_endian>::writeval(wv, val);
                       ...
                       Overflow_info<big_endian>* overflow_info)
  {
        ...
        && (check_overflow<11>(x, CHECK_SIGNED) == This::STATUS_OVERFLOW))
    {
      overflow_info->value = x;
      overflow_info->insn = val;
      overflow_info->name = "R_MICROMIPS_PC10_S1";
      overflow_info->bitsize = 11;
      return This::STATUS_OVERFLOW;
    }

    x = ((x & ~0x1) | ((x >> 10) & 0x1));
    val = Bits<10>::bit_select32(val, x, 0x3ff);
    elfcpp::Swap<16, big_endian>::writeval(wv, val);
                       ...
                       Overflow_info<big_endian>* overflow_info)
  {
    ...
    if (should_check_overflow
        && (check_overflow<26>(x, CHECK_SIGNED) == This::STATUS_OVERFLOW))
      {
        overflow_info->value = x;
        overflow_info->insn = val;
        overflow_info->name = "R_MICROMIPS_PC25_S1";
        overflow_info->bitsize = 26;
        return This::STATUS_OVERFLOW;
      }

    x = ((x & ~0x1) | ((x >> 25) & 0x1));
    val = Bits<25>::bit_select32(val, x, 0x1ffffff);
    elfcpp::Swap<32, big_endian>::writeval(wv, val);
                       ...
                       Overflow_info<big_endian>* overflow_info)
  {
        ...
        && (check_overflow<22>(x, CHECK_SIGNED) == This::STATUS_OVERFLOW))
    {
      overflow_info->value = x;
      overflow_info->insn = val;
      overflow_info->name = "R_MICROMIPS_PC21_S1";
      overflow_info->bitsize = 22;
      return This::STATUS_OVERFLOW;
    }

    x = ((x & ~0x1) | ((x >> 21) & 0x1));
    val = Bits<21>::bit_select32(val, x, 0x1fffff);
    elfcpp::Swap<32, big_endian>::writeval(wv, val);
                       ...
                       Overflow_info<big_endian>* overflow_info)
  {
        ...
        && (check_overflow<15>(x, CHECK_SIGNED) == This::STATUS_OVERFLOW))
    {
      overflow_info->value = x;
      overflow_info->insn = val;
      overflow_info->name = "R_MICROMIPS_PC14_S1";
      overflow_info->bitsize = 15;
      return This::STATUS_OVERFLOW;
    }
                       ...
                       Overflow_info<big_endian>* overflow_info)
  {
        ...
        && (check_overflow<12>(x, CHECK_SIGNED) == This::STATUS_OVERFLOW))
    {
      overflow_info->value = x;
      overflow_info->insn = val;
      overflow_info->name = "R_MICROMIPS_PC11_S1";
      overflow_info->bitsize = 12;
      return This::STATUS_OVERFLOW;
    }

    x = ((x & ~0x1) | ((x >> 11) & 0x1));
    val = Bits<11>::bit_select32(val, x, 0x7ff);
    elfcpp::Swap<32, big_endian>::writeval(wv, val);
                      ...
                      Overflow_info<big_endian>* overflow_info)
  {
    ...
    if (check_overflow<5>(x, CHECK_UNSIGNED) == This::STATUS_OVERFLOW)
    {
      overflow_info->value = x;
      overflow_info->insn = val;
      overflow_info->name = "R_MICROMIPS_PC4_S1";
      overflow_info->bitsize = 5;
      return This::STATUS_OVERFLOW;
    }
                          ...
                          Overflow_info<big_endian>* overflow_info)
  {
    ...
    if (should_check_overflow
        && (check_overflow<21>(x, CHECK_UNSIGNED) == This::STATUS_OVERFLOW))
      {
        ...
        overflow_info->value = x;
        overflow_info->insn = val;
        overflow_info->name = "R_MICROMIPS_GPREL19_S2";
                          ...
                          Overflow_info<big_endian>* overflow_info)
  {
    ...
    if (should_check_overflow
        && (check_overflow<21>(x, CHECK_UNSIGNED) == This::STATUS_OVERFLOW))
      {
        ...
        overflow_info->value = x;
        overflow_info->insn = val;
        overflow_info->name = "R_MICROMIPS_GPREL18_S3";
        overflow_info->bitsize = 21;
        return This::STATUS_OVERFLOW;
      }
                       ...
                       Overflow_info<big_endian>* overflow_info)
  {
    ...
    if (should_check_overflow
        && (check_overflow<18>(x, CHECK_UNSIGNED) == This::STATUS_OVERFLOW))
      {
        overflow_info->value = x;
        overflow_info->insn = val;
        overflow_info->name = "R_MICROMIPS_GPREL18";
                          ...
                          Overflow_info<big_endian>* overflow_info)
  {
    ...
    if (should_check_overflow
        && (check_overflow<18>(x, CHECK_UNSIGNED) == This::STATUS_OVERFLOW))
      {
        overflow_info->value = x;
        overflow_info->insn = val;
        overflow_info->name = "R_MICROMIPS_GPREL16_S2";
        overflow_info->bitsize = 18;
        return This::STATUS_OVERFLOW;
      }
                         ...
                         Overflow_info<big_endian>* overflow_info)
  {
    ...
    if (should_check_overflow
        && (check_overflow<9>(x, CHECK_UNSIGNED) == This::STATUS_OVERFLOW))
      {
        overflow_info->value = x;
        overflow_info->insn = val;
        overflow_info->name = "R_MICROMIPS_GPREL7_S2";
        overflow_info->bitsize = 9;
        return This::STATUS_OVERFLOW;
      }
  ...
  // R_MICROMIPS_GPREL_HI20
  static inline typename This::Status
  relmicromips_gprel_hi20(unsigned char* view,
                          const Mips_relobj<size, big_endian>* object,
                          const Symbol_value<size>* psymval, Mips_address gp,
                          Mips_address addend, bool local)
  {
  ...
  // R_MICROMIPS_GPREL_LO12
  static inline typename This::Status
  relmicromips_gprel_lo12(unsigned char* view,
                          const Mips_relobj<size, big_endian>* object,
                          const Symbol_value<size>* psymval, Mips_address gp,
                          Mips_address addend, bool local)
  {
  ...
  // R_MIPS_SIGNED_8
  static inline typename This::Status
  rels8(unsigned char* view, const Mips_relobj<size, big_endian>* object,
        const Symbol_value<size>* psymval, Mips_address addend,
        bool calculate_only, Valtype* calculated_value,
        Overflow_info<big_endian>* overflow_info)
  {
    ...
    if (check_overflow<8>(x, CHECK_SIGNED) == This::STATUS_OVERFLOW)
      {
        overflow_info->value = x;
        overflow_info->insn = 0;
        overflow_info->name = "R_MIPS_SIGNED_8";
        overflow_info->bitsize = 8;
        return This::STATUS_OVERFLOW;
      }
  ...
  // R_MIPS_SIGNED_16
  static inline typename This::Status
  rels16(unsigned char* view, const Mips_relobj<size, big_endian>* object,
         const Symbol_value<size>* psymval, Mips_address addend,
         bool calculate_only, Valtype* calculated_value,
         Overflow_info<big_endian>* overflow_info)
  {
    ...
    if (check_overflow<16>(x, CHECK_SIGNED) == This::STATUS_OVERFLOW)
      {
        overflow_info->value = x;
        overflow_info->insn = 0;
        overflow_info->name = "R_MIPS_SIGNED_16";
        overflow_info->bitsize = 16;
        return This::STATUS_OVERFLOW;
      }
    ...
    unsigned int expand_reg)
{
  ...
  if (this->r_type_ == elfcpp::R_MICROMIPS_PC25_S1)
           ...
           || this->r_type_ == elfcpp::R_MICROMIPS_GPREL17_S1)
    {
      // Change existing relocation.
      reloc_current.put_r_info(
        elfcpp::elf_r_info<size>(r_sym, elfcpp::R_MICROMIPS_GPREL_HI20));
      ...
      reloc_new.put_r_info(
        elfcpp::elf_r_info<size>(r_sym, elfcpp::R_MICROMIPS_GPREL_LO12));
                        ...
                        section_size_type)
{
  ...
  if (rel_type == elfcpp::SHT_RELA)
    {
      ...
      r_ssym = Mips_classify_reloc<elfcpp::SHT_RELA, size, big_endian>::
          get_r_ssym(&rela);
      r_addend = rela.get_r_addend();
      // If this is not the last relocation, get r_offset and r_type of the next
      // relocation.
  ...
  Overflow_info<big_endian> overflow_info;
  // Whether we have to extract addend from the instruction.
  ...
  for (unsigned int i = 0; i < 3; ++i)
    {
      ...
      // If we didn't apply the previous relocation, use its result as addend
      // for current.
      ...
      switch (r_types[i])
        ...
        case elfcpp::R_MICROMIPS_GPREL16:
          reloc_status = Reloc_funcs::relgprel(view, object, psymval,
                                            ...
                                            r_addend, extract_addend,
                                            gsym == NULL, this->calculate_only_,
                                            &this->calculated_value_);
          break;
        ...
        case elfcpp::R_MIPS_UNSIGNED_16:
          reloc_status = Reloc_funcs::relu16(view, object, psymval, r_addend,
                                             ...
                                             &overflow_info);
          break;
        case elfcpp::R_MIPS_SIGNED_8:
          reloc_status = Reloc_funcs::rels8(view, object, psymval, r_addend,
                                            this->calculate_only_,
                                            &this->calculated_value_,
                                            &overflow_info);
          break;
        case elfcpp::R_MIPS_SIGNED_16:
          reloc_status = Reloc_funcs::rels16(view, object, psymval, r_addend,
                                             this->calculate_only_,
                                             &this->calculated_value_,
                                             &overflow_info);
          break;
        ...
        case elfcpp::R_MICROMIPS_GPREL_HI20:
          ...
          break;
        case elfcpp::R_MICROMIPS_GPREL_LO12:
          reloc_status = Reloc_funcs::relmicromips_gprel_lo12(view, object,
                                     psymval, target->adjusted_gp_value(object),
                                     r_addend, gsym == NULL);
          break;
        case elfcpp::R_MICROMIPS_32:
      ...
      if (gsym == NULL)
        {
          gold_error_at_location(relinfo, relnum, r_offset,
                                 ...
                                 overflow_info.bitsize, overflow_info.insn);
        }
      else if (gsym->is_defined() && gsym->source() == Symbol::FROM_OBJECT)
        {
          gold_error_at_location(relinfo, relnum, r_offset,
                                 ...
                                 overflow_info.value, overflow_info.bitsize,
                                 overflow_info.insn);
        }
      else
        {
